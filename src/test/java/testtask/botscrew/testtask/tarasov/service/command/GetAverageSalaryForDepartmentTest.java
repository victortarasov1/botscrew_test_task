...
class GetAverageSalaryForDepartmentTest {
    private DepartmentRepository departmentRepository;
    private Command command;
    private final static String VALID_QUERY = "Show the average salary for the department Mathematics";
    private final static String INVALID_QUERY = "Showwww theaverage salari for the department Mathematics";

    @BeforeEach
    public void setUp() {
        departmentRepository = mock(DepartmentRepository.class);
        command = new GetAverageSalaryForDepartment(departmentRepository);
    }
