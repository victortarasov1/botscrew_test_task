...
class GetDepartmentStatisticsTest {
    private DepartmentRepository departmentRepository;
    private Command command;
    private final static String VALID_QUERY = "Show Mathematics statistics";
    private final static String INVALID_QUERY = "Showwww statistics Mathematics";

    @BeforeEach
    public void setUp() {
        departmentRepository = mock(DepartmentRepository.class);
        command = new GetDepartmentStatistics(departmentRepository);
    }
